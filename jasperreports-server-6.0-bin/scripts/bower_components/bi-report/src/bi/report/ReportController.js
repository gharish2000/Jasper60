 ...
 * @version: $Id: ReportController.js 2845 2014-11-12 12:24:15Z ktsaregradskyi $
 */
        ...
        this.model
            ...
            dfd.fail(function(response) {
                ...
                if (response.readyState === 4 &&
                    response.status === 500) {
                        self.components.get(actionObject[actionObject.chartComponentUuid ? "chartComponentUuid" : "tableUuid"]).
