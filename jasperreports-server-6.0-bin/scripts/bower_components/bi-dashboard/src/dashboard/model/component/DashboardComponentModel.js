 ...
 * @version: $Id: DashboardComponentModel.js 895 2014-10-22 11:38:20Z ktsaregradskyi $
 */
...
define(function (require, exports, module) {
    ...
    var DashboardComponentModel = Backbone.Model.extend({
        ...
        generateId: function(name) {
            var id = _any([name, this.get("name"), this.componentName], _identify),
