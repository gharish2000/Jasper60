...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/lib/require-2.1.10.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/require.config.js"></script>
        <script type="text/javascript">
            require(["example/inputControlUI"]);
        </script>
    ...
    <t:putAttribute name="bodyContent" >
		...
		<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
		    ...
		    <t:putAttribute name="bodyContent" >
                ...
                <div>
                    <ul class="list">
                        <li id="booleanControl"></li>
                        <li id="singleTextValueControl"></li>
                        <li id="singleNumberValueControl"></li>
                        <li id="singleValueDateControl"></li>
                        <li id="singleValueDateTimeControl"></li>
                        <li id="singleValueTimeControl"></li>
                        <li id="singleSelectControl"></li>
                        <li id="multiSelectControl"></li>
                        <li id="singleRadioControl"></li>
                        <li id="multipleCheckboxControl"></li>
                    </ul>
